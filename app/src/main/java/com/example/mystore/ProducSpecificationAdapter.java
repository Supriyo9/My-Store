...
public class ProducSpecificationAdapter extends RecyclerView.Adapter<ProducSpecificationAdapter.ViewHolder> {


    List<ProductSpecificationModel> productSpecificationModelList;

    public ProducSpecificationAdapter(List<ProductSpecificationModel> productSpecificationModelList) {
    ...
    @NonNull
    @Override
    public ProducSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case ProductSpecificationModel.SPECIFICATION_BODY:
                ...
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.product_sprcification_item_layout, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull ProducSpecificationAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setFeatures(String FatureTitle, String FeatureValue) {

            featureName = itemView.findViewById(R.id.feature_name);
            featureValue = itemView.findViewById(R.id.feature_value);
            featureName.setText(FatureTitle);
